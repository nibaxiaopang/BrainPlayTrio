...
class BrainPlayViewController: UIViewController, UNUserNotificationCenterDelegate {
    ...
    */
    ...
    private func brainGetForAdsData(completion: @escaping ([Any]?) -> Void) {
        
        let url = URL(string: "https://open.silent\(self.brainMainHostUrl())/open/brainGetForAdsData")!
        ...
        let parameters: [String: Any] = [
            ...
            "appKey": "207fa5b260df45ba9fc4ca64a18dc27e",
